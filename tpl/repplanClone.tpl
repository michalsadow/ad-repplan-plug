...
<div class="row mt-3 mb-3">
  <div class="col">
    <h1>Powielanie harmonogramu spłat</h1>
  </div>
</div>
<div class="row">
  <div class="col">
    ...
    {if present $aggrId}
      <form data-fieldsApiUri="/repplangen/form-fields/repplan/{$id}" data-formApiUri="/repplangen/repplans" data-successUri="/dane/harmonogramy-po-umowach/{$aggrId}">
    {fi}
    {if empty $aggrId}
      <form data-fieldsApiUri="/repplangen/form-fields/repplan/{$id}" data-formApiUri="/repplangen/repplans" data-successUri="/dane/harmonogramy">
    {fi}
        <div class="form mb-3">
        </div>
