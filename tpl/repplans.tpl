...
<div class="row mt-3 mb-3">
  <div class="col">
    <h1>Wygenerowane harmonogramy spłat</h1>
  </div>
</div>
...
<div class="row">
  <div class="col">
    ...
    <p>Poniżej przedstawiona jest lista wygenerowanych w programie harmonogramów spłat.</p>

    <div class="alerts"></div>

    <a class="btn mb-3 btn-primary" href="/dane/harmonogramy/dodaj">dodaj nowy harmonogram spłat</a>

    <table class="table table-sm" data-rowsApiUri="/repplangen/repplans">
      <thead>
        <tr>
        ...
        <tr class="js-ad-list-specimen" data-rowId="{ajax id}">
          ...
          <td class="redNoGreenYes{ajax inForce}" style="cursor:pointer;"><a href="/dane/harmonogramy/{ajax id}/{ajax possibleReactionLoc}">{ajax inForceLoc}</a></td>
          <td class="align-middle text-center ad-operations">
            <a href="/dane/harmonogramy/{ajax id}/edytuj" class="btn btn-success btn-sm">edytuj</a>
            <a href="{ajax xlsxUri}" target="_blank" class="btn btn-success btn-sm">XLSX</a>
            <a href="/dane/harmonogramy/{ajax id}/powiel" class="btn btn-success btn-sm">powiel</a>
            <a href="/dane/harmonogramy/{ajax id}/kasuj" class="btn btn-danger btn-sm">usuń</a>
          </td>
        </tr>
      </thead>
      <tbody>
